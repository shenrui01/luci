...
elseif rule_type == "redirect" then
	...
	o = s:option(Value, "src_port",
		...
		translate("Match incoming traffic originating from the given source port or port range on the client host."))
	o.rmempty = true
	...
	o = s:option(Value, "dest_port",
		...
		translate("Match forwarded traffic to the given destination port or port range."))
